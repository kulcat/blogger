    ...
    <div class="d-flex flex-column">
      ...
      <div class="row d-flex flex-column gap-3 my-3">
        <div class="d-flex align-items-center gap-1">
          ...
          <RouterLink class="text-reset text-decoration-none" :to="{ name: 'Account' }">
            <button v-if="AppState.account.id == profileBlogs[0].creatorId" class="btn btn-warning my-3"
        ...
        <div>
          <button v-if="AppState.account.id == profileBlogs[0].creatorId" class="btn btn-warning my-3"
            data-bs-toggle="modal" data-bs-target="#newBlogModal" style="width: 3rem; height: 3rem;">
